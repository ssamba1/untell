...
| **Black-box alignment humanizer** (MASH: style-injection SFT → DPO → inference refinement) | ✅ **92% ASR** across 5 detectors / 6 datasets, beat 11 baselines, **quality preserved**, no white-box access — **confirmed verbatim against the published abstract**, which adds that it beats the strongest baseline by 24% | **peer-reviewed**: [2026.findings-acl.1487](https://aclanthology.org/2026.findings-acl.1487/) (was cited here as preprint 2601.08564) | **The deployable product architecture.** |
