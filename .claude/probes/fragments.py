...
FINITE = re.compile(
    r"\b(?:is|are|was|were|has|have|had|do|does|did|will|would|can|could|may|might|shall|should|must|am|be|been|being|seems?|appears?|becomes?|remains?)\b",
    re.I,
)
SUBORD = re.compile(
    r"^(?:although|though|while|because|since|whereas|unless|if|when|where|as|even though|despite)\b",
    re.I,
)
