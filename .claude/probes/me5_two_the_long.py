...
S1 = (
    "The committee reviewed the annual budget report and then approved the revised "
    "spending plan for the coming fiscal year without any further discussion among "
    "the members present at the meeting. "
)
S2 = (
    "The directors supported the new initiative after examining the projected costs "
