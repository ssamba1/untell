...
clean = (
    "The kettle boiled while I read the mail. Outside, the rain had stopped and the street "
...
r = subprocess.run(
    [sys.executable, "-m", "untell.scripts.verify", "--tier", "lite", clean],
    capture_output=True,
    text=True,
    env=env,
    timeout=180,
...
r2 = subprocess.run(
    [sys.executable, "-m", "untell.scripts.verify", "--tier", "lite", ai],
    capture_output=True,
    text=True,
    env=env,
    timeout=180,
