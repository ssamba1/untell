...
out["false_range"] = bool(
    _FALSE_RANGE_RE.search("Whether you're a beginner or an expert, this works.")
)
out["false_range_headline"] = bool(
    _FALSE_RANGE_RE.search("from ancient civilizations to modern startups")
)
