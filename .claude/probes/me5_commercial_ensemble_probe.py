...
print(
    "P1 commercial in _TIER_RANK:",
    "commercial" in _TIER_RANK,
    "| rank:",
    _TIER_RANK.get("commercial"),
)
...
TEXT = (
    "The committee reviewed the proposal and decided to postpone the decision until next quarter. "
    * 4
)
...
try:
    ...
    ens3._members = [
        ("fail_cand", _Cand("fail_cand", FAILING)),
        ("pass_cand", _Cand("pass_cand", PASSING)),
    ]
