...
try:
    r0 = R.untell_text(
        "Some input text long enough to score.", tier="lite", max_iters=2, seed=1, confirm=0
    )
    calls["n"] = 0
    r2 = R.untell_text(
        "Some input text long enough to score.", tier="lite", max_iters=2, seed=1, confirm=2
    )
    out = {
