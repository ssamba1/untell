...
t = (
    "The system reads the file. The parser splits it. The loader writes it. The checker validates it. "
...
t2 = (
    "The system reads the file. Then the parser splits it. The loader writes it. After that the checker runs. "
    "Each component works in sequence with the others."
)
out["two_the"] = _duplicate_sentence_starts(t2)
# varied starts -> 0
t3 = (
    "The system reads the file. Then the parser splits it. Next the loader writes it. After that the checker runs. "
    "Each component works in sequence with the others."
)
