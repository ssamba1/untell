...
cases = {
    "role_swap": (
        "The company sued the regulator over the new rules.",
        "The regulator sued the company over the new rules.",
    ),
    "faithful": (
        "The intervention halved mortality in the trial group over six months.",
        "The treatment cut deaths in the study group by half during the six months.",
    ),
    "same": ("The company sued the regulator.", "The company sued the regulator."),
    "different_topic": ("The company sued the regulator.", "Cats are pleasant animals."),
    "empty": ("", "anything"),
}
