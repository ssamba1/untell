...
out = {}
# stdlib mode -> 0.45
out["stdlib"] = _verdict_threshold(
    0.3, {"perplexity_burstiness": 0.4}, {"perplexity_burstiness": "stdlib"}
)
# gpt2 mode -> 0.3
out["gpt2"] = _verdict_threshold(
    0.3, {"perplexity_burstiness": 0.4}, {"perplexity_burstiness": "gpt2"}
)
# mixed modes -> ?
