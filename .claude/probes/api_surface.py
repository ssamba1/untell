...
r = client.post(
    "/score",
    json={"text": "The system reads the file and processes the records in order.", "tier": "lite"},
)
...
# /tells
r = client.post(
    "/tells", json={"text": "Moreover, the framework leverages robust solutions.", "tier": "lite"}
)
...
r = client.post(
    "/ceiling",
    json={
        "text": "The system reads the file and processes the records in order.",
        "tier": "lite",
        "repeats": 1,
    },
)
