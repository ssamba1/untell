...
restored = restore(
    "the New York Times published the report, and ⟦HZ0000⟧ is just one outlet.".replace(
        "⟦HZ0000⟧", [k for k in mp if mp[k] == "the New York Times"][0]
    ),
    mp,
)
print("A restored:", restored)
print(
    "A has 'the ⟦' or 'The ' artifact:",
    "the New York Times" in restored and "The New York Times" not in restored,
)
