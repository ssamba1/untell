...
out = {}
sample = (
    "I walked down to the corner store and bought some milk, but it started raining on the way home, "
...
draft = (
    "I walked to the corner store for milk, and rain began falling on the walk home. I paused under a tree "
    "to wait, and the evening stayed quiet. When it cleared I continued, finding the street empty."
)
p = style_profile(sample)
out["six_features"] = sorted(p.keys()) == [
    "burst",
    "comma_per_100w",
