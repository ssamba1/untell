...
out["s1_merges"] = r1.count(",") > rewrite(
    "The system reads the file. The parser splits it. The loader writes it.", 0.0
).count(",")
...
sp = single_pass(
    "The system reads the file. The parser splits it into records. The loader writes them to the store."
)
